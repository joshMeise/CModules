/* 
 * testRemoveMiddle.c --- tests removing element from middle of queue
 * 
 * Author: Joshua M. Meise
 * Created: 10-09-2023
 * Version: 1.0
 * 
 * Description: This program tests removing an element from the middle of a queue.
 * 
 */
 ...
 * outputs: nothing
 */
static void printperson(void *p){
 ...
 */
static bool searchfunc(void *p, const void* keyp){
