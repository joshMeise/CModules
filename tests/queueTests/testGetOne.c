/* 
 * testGetOne.c --- get person from queue when oinly one person in queue
 * 
 * Author: Joshua M. Meise
 * Created: 10-09-2023
 * Version: 1.0
 * 
 * Description: Test getting from queue when only 1 person is in queue.
 * 
 */
