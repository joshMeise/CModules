/* 
 * testRemoveMiddleThenApply.c --- test removing from middle then printing
 * 
 * Author: Joshua M. Meise
 * Created: 10-09-2023
 * Version: 1.0
 * 
 * Description: Removes a person from the middle of the queue and then prints the queue.
 * 
 */
...
int main(void) {
	...
	// Remove a person from the middiel of the queue.
